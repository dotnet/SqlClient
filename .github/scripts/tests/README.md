...
| `cherry-pick-to-release.bats` | 21 | Branch derivation, already-applied detection, clean cherry-pick, conflict handling, milestone lookup, PR creation, duplicate skip logic, backport-issue lookup and `Fixes #` linking |
