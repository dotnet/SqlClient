...
Active release milestones with their target dates and progress:

| Milestone | Target Date | Status |
|-----------|-------------|--------|
| **6.1.6** | June 11, 2026 | Servicing |
| **7.0.2** | June 11, 2026 | Servicing |
| **7.1.0-preview2** | June 24, 2026 | In Progress |
| **7.1.0-preview3** | August 26, 2026 | Planned |
| **7.1.0** | September 16, 2026 | Planned |

For milestone details and changes included, see [SqlClient milestones](https://github.com/dotnet/SqlClient/milestones).
...
| Vector subtype support — `int` and `bit` | Planned | — |
...
| Feature | Status | ETA |
|---------|--------|-----|
| Expose connection encryption information to clients | September 2026 | — |
| Throw `TaskCanceledException` instead of `SqlException` for cancellations | September 2026 | — |
