...
## [Preview Release 5.1.0-preview1.22279.3] - 2022-10-06
...
- When using `Encrypt=Strict` with TLS v1.3, the TLS handshake occurs twice on initial connection. This will be fixed in a future release.
