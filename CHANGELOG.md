...
## [Stable Release 2.0.1] - 2020-08-21
...
### Fixed
- Fixed pooled connection re-use on access token expiry for supported Active Directory Authentication modes [#639](https://github.com/dotnet/SqlClient/pull/639)
