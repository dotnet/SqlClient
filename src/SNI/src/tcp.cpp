...
Tcp * Tcp::AcceptConnection( SNI_Conn *pConn, SOCKET AcceptSocket, char * szAddressBuffer)
{
	...
	// TODO: chec later if we need this???
	BOOL	foptval  = TRUE;
	...
	// TODO: Need to provide an api to do this
...
DWORD Tcp::Close(DWORD dwFlags)
{
	...
	//tcp::close. 
	//
	//See more details on MSDN regarding to shutdown, closesocket and graceful shutdown.
	//
