...
{
    /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/Format.xml' path='docs/members[@name="Format"]/Format/*' />
    public enum Format
    {
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/Format.xml' path='docs/members[@name="Format"]/Unknown/*' />
        Unknown = 0,
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/Format.xml' path='docs/members[@name="Format"]/Native/*' />
        Native = 1,
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/Format.xml' path='docs/members[@name="Format"]/UserDefined/*' />
        UserDefined = 2,
    }

    /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/SqlUserDefinedTypeAttribute/*' />
    ...
    public sealed class SqlUserDefinedTypeAttribute : Attribute
    {
        ...
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/ctor/*' />
        ...
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/MaxByteSize/*' />
        ...
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/IsFixedLength/*' />
        ...
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/IsByteOrdered/*' />
        ...
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/Format/*' />
        // The on-disk format for this type.
        public Format Format => _format;

        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/ValidationMethodName/*' />
        ...
        /// <include file='../../doc/snippets/Microsoft.SqlServer.Server/SqlUserDefinedTypeAttribute.xml' path='docs/members[@name="SqlUserDefinedTypeAttribute"]/Name/*' />
        public string Name
        {
            get
            {
