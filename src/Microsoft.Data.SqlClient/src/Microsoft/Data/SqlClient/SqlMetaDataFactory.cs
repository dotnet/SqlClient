...
namespace Microsoft.Data.SqlClient
{
    ...
    {    
        ...
        private readonly static MetaDataCollectionBase[] s_metaDataCollection = [
            ...
            new SqlCommandCollection("Users",                  1, 
                    ...
                    [new Restriction("User_Name", "@Name", "name")]),
            new SqlCommandCollection("Databases",              1,
                    ...
                    [new Restriction("Name", "@Name", "Name")]),
            new SqlCommandCollection("Tables",                 3,
                    ...
                    [new Restriction("Catalog", "@Catalog", "TABLE_CATALOG"),
                     new Restriction("Owner", "@Owner", "TABLE_SCHEMA"),
                     new Restriction("Table", "@Name", "TABLE_NAME"),
                     new Restriction("TableType", "@TableType", "TABLE_TYPE")]),
            new SqlCommandCollection("Columns",                4,
                    ...
                    [new Restriction("Catalog", "@Catalog", "TABLE_CATALOG"),
                     new Restriction("Owner", "@Owner", "TABLE_SCHEMA"),
                     new Restriction("Table", "@Table", "TABLE_NAME"),
                     new Restriction("Column", "@Column", "COLUMN_NAME")]),
            new SqlCommandCollection("AllColumns",             4,
                    [new SupportedQuery("10.00.000.0", null, "EXEC sys.sp_columns_managed @Catalog, @Owner, @Table, @Column, 1")],
                    [new Restriction("Catalog", "@Catalog", "TABLE_CATALOG"),
                     new Restriction("Owner", "@Owner", "TABLE_SCHEMA"),
                     new Restriction("Table", "@Table", "TABLE_NAME"),
                     new Restriction("Column", "@Column", "COLUMN_NAME")]),
            new SqlCommandCollection("ColumnSetColumns",       3,
                    [new SupportedQuery("10.00.000.0", null, "EXEC sys.sp_columns_managed @Catalog, @Owner, @Table, null, 2")],
                    [new Restriction("Catalog", "@Catalog", "TABLE_CATALOG"),
                     new Restriction("Owner", "@Owner", "TABLE_SCHEMA"),
                     new Restriction("Table", "@Table", "TABLE_NAME")]),
            new SqlCommandCollection("StructuredTypeMembers",  4,
                    ...
                    [new Restriction("Catalog", "@Catalog", "TYPE_CATALOG"),
                     new Restriction("Owner", "@Owner", "TYPE_SCHEMA"),
                     new Restriction("Type", "@Type", "TYPE_NAME"),
                     new Restriction("Member", "@Member", "MEMBER_NAME")]),
            new SqlCommandCollection("Views",                  3,
                    ...
                    [new Restriction("Catalog", "@Catalog", "TABLE_CATALOG"),
                     new Restriction("Owner", "@Owner", "TABLE_SCHEMA"),
                     new Restriction("Table", "@Table", "TABLE_NAME")]),
            new SqlCommandCollection("ViewColumns",            4,
                    ...
                    [new Restriction("Catalog", "@Catalog", "VIEW_CATALOG"),
                     new Restriction("Owner", "@Owner", "VIEW_SCHEMA"),
                     new Restriction("Table", "@Table", "VIEW_NAME"),
                     new Restriction("Column", "@Column", "COLUMN_NAME")]),
            new SqlCommandCollection("ProcedureParameters",    1,
                    ...
                    [new Restriction("Catalog", "@Catalog", "SPECIFIC_CATALOG"),
                     new Restriction("Owner", "@Owner", "SPECIFIC_SCHEMA"),
                     new Restriction("Name", "@Name", "SPECIFIC_NAME"),
                     new Restriction("Parameter", "@Parameter", "PARAMETER_NAME")]),
            new SqlCommandCollection("Procedures",             3,
                    ...
                    [new Restriction("Catalog", "@Catalog", "SPECIFIC_CATALOG"),
                     new Restriction("Owner", "@Owner", "SPECIFIC_SCHEMA"),
                     new Restriction("Name", "@Name", "SPECIFIC_NAME"),
                     new Restriction("Type", "@Type", "ROUTINE_TYPE")]),
            new SqlCommandCollection("IndexColumns",           4,
                    ...
                    [new Restriction("Catalog", "@Catalog", "db_name()"),
                     new Restriction("Owner", "@Owner", "user_name()"),
                     new Restriction("Table", "@Table", "o.name"),
                     new Restriction("ConstraintName", "@ConstraintName", "x.name"),
                     new Restriction("Column", "@Column", "c.name")]),
            new SqlCommandCollection("Indexes",                3,
                    ...
                    [new Restriction("Catalog", "@Catalog", "db_name()"),
                     new Restriction("Owner", "@Owner", "user_name()"),
                     new Restriction("Table", "@Table", "o.name"),
                     new Restriction("Name", "@Name", "x.name")]),
            new SqlCommandCollection("UserDefinedTypes",       1,
                    ...
                    [new Restriction("assembly_name", "@AssemblyName", "assemblies.name"),
                     new Restriction("udt_name", "@UDTName", "types.assembly_class")]),
            new SqlCommandCollection("ForeignKeys",            3,
                    ...
                    [new Restriction("Catalog", "@Catalog", "CONSTRAINT_CATALOG"),
                     new Restriction("Owner", "@Owner", "CONSTRAINT_SCHEMA"),
                     new Restriction("Table", "@Table", "TABLE_NAME"),
                     new Restriction("Name", "@Name", "CONSTRAINT_NAME")]),
            new SqlCommandCollection("_TVPs",                  2,
                    ...
                    []),
            new SqlCommandCollection("_UDTs",                  2,
        ...
        internal sealed class Restriction
        {
            ...
            public string RestrictionDefault { get; init; }

            internal Restriction(string restrictionName, string parameterName,string restrictionDefault)
            {
                RestrictionName = restrictionName;
                ParameterName = parameterName;
                RestrictionDefault = restrictionDefault;
            }
        }
        ...
        internal abstract class MetaDataCollectionBase
        {
            ...
            public virtual int NumberOfRestrictions => 0;
            public int NumberOfIdentifierParts { get; init; }

            internal MetaDataCollectionBase(string collectionName, int numberOfIdentifierParts)
            {
