    ...
    {    
        ...
        private readonly static MetaDataCollectionBase[] s_metaDataCollection = [
            ...
            new SqlCommandCollection("Users",                  1, 
                    ...
                    [new Restriction("User_Name", "@Name")]),
            ...
            new SqlCommandCollection("Tables",                 3,
                    ...
                    [new Restriction("Catalog", "@Catalog"),
                     new Restriction("Owner", "@Owner"),
                     new Restriction("Table", "@Name"),
                     new Restriction("TableType", "@TableType")]),
            new SqlCommandCollection("Columns",                4,
                    ...
                    [new Restriction("Catalog", "@Catalog"),
                     new Restriction("Owner", "@Owner"),
                     new Restriction("Table", "@Table"),
                     new Restriction("Column", "@Column")]),
            ...
            new SqlCommandCollection("StructuredTypeMembers",  4,
                    ...
                    [new Restriction("Catalog", "@Catalog"),
                     new Restriction("Owner", "@Owner"),
                     new Restriction("Type", "@Type"),
                     new Restriction("Member", "@Member")]),
            ...
            new SqlCommandCollection("ProcedureParameters",    1,
                    ...
                    [new Restriction("Catalog", "@Catalog"),
                     new Restriction("Owner", "@Owner"),
                     new Restriction("Name", "@Name"),
                     new Restriction("Parameter", "@Parameter")]),
            ...
            new SqlCommandCollection("IndexColumns",           4,
                    ...
                    [new Restriction("Catalog", "@Catalog"),
                     new Restriction("Owner", "@Owner"),
                     new Restriction("Table", "@Table"),
                     new Restriction("ConstraintName", "@ConstraintName"),
                     new Restriction("Column", "@Column")]),
            ...
            new SqlCommandCollection("UserDefinedTypes",       1,
                    ...
                    [new Restriction("assembly_name", "@AssemblyName"),
                     new Restriction("udt_name", "@UDTName")]),
        ...
        internal sealed class Restriction
        {
            ...
            internal Restriction(string restrictionName, string parameterName)
            {
