...
public:
	...
	static DWORD AcquireCredentialsForClient(PCredHandle pHandle, 
                                                ...
                                                __in SNIAuthProviderInfo *pAuthInfo);
	...
	virtual DWORD GetContextHandle(__out PVOID *ppHandle)
	{
		*ppHandle = &m_hContext;
...
private:
	...
	WCHAR  		m_wchKeyContainer[64];
	DWORD		m_dwKeyContainerFlags;
	...
	static DWORD AcquireCertContext( SNIAuthProviderInfo *pAuthInfo,
										__out DWORD *pdwKeyContainerFlags,
										__in ULONG cchKeyContainer,
										__out_ecount(cchKeyContainer) WCHAR *pwchKeyContainer,
										__out HCERTSTORE *phCertStore, 
	...
	static DWORD IsValidAuthCert(PCCERT_CONTEXT   pCertContext, BOOL fServer );
