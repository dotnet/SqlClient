...
#define SNI_STRING_PROV_CTAIP		(SNI_STRING_PROV_BASE + 9)
#define SNI_STRING_PROV_MAX			(SNI_STRING_PROV_BASE + 10)
#define SNI_STRING_PROV_INVALID		(SNI_STRING_PROV_BASE + 11)
...
// The number gap here is intentional to keep CTAIP code the same across FXData and DS_Main.
//
#define SNIE_CTAIP					(SNI_STRING_ERROR_BASE + 68)
#define SNIE_69						(SNI_STRING_ERROR_BASE + 69)
#define SNIE_70						(SNI_STRING_ERROR_BASE + 70)
#define SNIE_71						(SNI_STRING_ERROR_BASE + 71)
#define SNIE_72						(SNI_STRING_ERROR_BASE + 72)
#define SNIE_73						(SNI_STRING_ERROR_BASE + 73)
#define SNIE_74						(SNI_STRING_ERROR_BASE + 74)
#define SNIE_75						(SNI_STRING_ERROR_BASE + 75)
#define SNIE_MAX					SNIE_75
