...
WCHAR * SNI_Error_String[] =
{
    ...
    L"",
    L"",
    L"The data buffer size is not big enough in CTAIP packet",
    L"Unknown CTAIP protocol version",
    L"Invalid format in CTAIP packet",
    L"Invalid token in CTAIP packet",
    L"Invalid data in CTAIP packet",
    L"Conflict tokens in CTAIP packet",
    L"Generic error in CTAIP packet"
};
