...
{
	//	REVIEW: printing the uninitialized strings may cause buffer
	//		overruns.  This mat apply to other functions and files as well.  
	//
	BidxScopeAutoSNI0( SNIAPI_TAG _T(""));
...
#define VIP_NET_ADDRESS_ALIGNMENT 8
	...
	BOOL fAddr = FALSE;
	WCHAR *pwszPort = NULL;
	DWORD dwNic = 0; //TODO: parse the NIC index from connect params. For now, 0 is the default
	...
	// Create a VI. Dont associate the send queue with CQ in sync case. TODO: Is this enforced by SNI?
