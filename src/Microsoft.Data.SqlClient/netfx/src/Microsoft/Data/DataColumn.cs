...
namespace Microsoft.Data {
    ...
    /// <devdoc>
    ///    <para>
    ///       Represents one column of data in a <see cref='Microsoft.Data.DataTable'/>.
    ///    </para>
    /// </devdoc>
    [
    ToolboxItem(false),
 ...
 public class DataColumn : MarshalByValueComponent {
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of a <see cref='Microsoft.Data.DataColumn'/>
        ///       class.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Inititalizes a new instance of the <see cref='Microsoft.Data.DataColumn'/> class
        ...
        ///       of the <see cref='Microsoft.Data.DataColumn'/> class
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of the <see cref='Microsoft.Data.DataColumn'/> class
        ///       using
        ...
        DefaultValue(true),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnAllowNullDescr)
        ]
        public bool AllowDBNull {
            ...
            set {
                ...
                try {
                    ...
                    // CONSIDER if (!unique && allowNull && null!=sortIndex) { sortIndex.RemoveRef; sortIndex=null; }
                }
                finally {
        ...
        DefaultValue(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnAutoIncrementDescr)
        ]
        ...
        ///    <see cref='Microsoft.Data.DataColumn.AutoIncrement'/> property
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnAutoIncrementSeedDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets or sets the increment used by a column with its <see cref='Microsoft.Data.DataColumn.AutoIncrement'/>
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnAutoIncrementStepDescr)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnCaptionDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Resets the <see cref='Microsoft.Data.DataColumn.Caption'/> property to its previous value, or
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets a value indicating whether the <see cref='Microsoft.Data.DataColumn.Caption'/> has been explicitly set.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets or sets the name of the column within the <see cref='Microsoft.Data.DataColumnCollection'/>.
        ///    </para>
        /// </devdoc>
        [
        RefreshProperties(RefreshProperties.All),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnColumnNameDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnPrefixDescr)
        ]
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnDataTypeDescr)
        ]
                ...
                if (dataType != value) {
                    ...
                    if (!DefaultValueIsNull) {
                        try {
                            ...
                            else if (typeof(string) == value) { // since string types can be null in value! DO NOT REMOVE THIS CHECK
                                defaultValue = DefaultValue.ToString();
                            }
                            else if (typeof(SqlString) == value) { // since string types can be null in value! DO NOT REMOVE THIS CHECK
        ...
        RefreshProperties(RefreshProperties.All),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnDateTimeModeDescr)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnDefaultValueDescr),
        ...
        RefreshProperties(RefreshProperties.All),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnExpressionDescr)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnMaxLengthDescr),
        DefaultValue(-1)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnNamespaceDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets the position of the column in the <see cref='Microsoft.Data.DataColumnCollection'/>
        ///       collection.
        ///    </para>
        /// </devdoc>
        [
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnOrdinalDescr)
        ]
        public int Ordinal {
            get {
                return _ordinal;
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnReadOnlyDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets the <see cref='Microsoft.Data.DataTable'/> to which the column belongs to.
        ///    </para>
        /// </devdoc>
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnDataTableDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnUniqueDescr),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)
        ]
        public bool Unique {
            get {
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataColumnMappingDescr)
        ]
        ...
        // Returns the <see cref='Microsoft.Data.DataColumn.Expression'/> of the column, if one exists.
