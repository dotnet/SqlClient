...
namespace Microsoft.Data.SqlClient
{
    ...
    internal sealed class SqlDataReaderSmi : SqlDataReader
    {
        ...
        public override Object GetValue(int ordinal)
        {
            ...
            if (_currentConnection.IsSql2008OrNewer)
            {
        ...
        public override TimeSpan GetTimeSpan(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetTimeSpan(_readerEventSink, _currentColumnValuesV3, ordinal, _currentMetaData[ordinal], _currentConnection.IsSql2008OrNewer);
        }

        public override DateTimeOffset GetDateTimeOffset(int ordinal)
        {
            EnsureCanGetCol("GetDateTimeOffset", ordinal);
            return ValueUtilsSmi.GetDateTimeOffset(_readerEventSink, _currentColumnValuesV3, ordinal, _currentMetaData[ordinal], _currentConnection.IsSql2008OrNewer);
        }
