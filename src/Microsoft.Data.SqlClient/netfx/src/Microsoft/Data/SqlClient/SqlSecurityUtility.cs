...
namespace Microsoft.Data.SqlClient
{
    internal static class SqlSecurityUtility
    {
        ...
        /// <summary>
        /// <para>
        /// Decrypts the symmetric key and saves it in metadata. In addition, intializes 
        /// the SqlClientEncryptionAlgorithm for rapid decryption.
        /// </para>
        /// </summary>
        /// <param name="md"></param>
        /// <param name="serverName"></param>
        ...
        /// <summary>
        /// <para>Decrypts the symmetric key and saves it in metadata.</para>
        /// </summary>
        /// <param name="sqlTceCipherInfoEntry"></param>
        /// <param name="serverName"></param>
        /// <param name="sqlClientSymmetricKey"></param>
        /// <param name="encryptionkeyInfoChosen"></param>
        ...
        /// <param name="serverName"></param>
        /// <param name="isEnclaveEnabled"></param>
        /// <param name="CMKSignature"></param>
