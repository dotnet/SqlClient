            ...
            try
            {
                lock (this)
                {
                    if (!_dependencyIdToDependencyHash.ContainsKey(dep.Id))
                    {
                        ...
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.AddCommandEntry|DEP> Dependency not present in depId->dep hash, must have been invalidated.");
                    }
                    else
                    {
                        ...
                        if (_commandHashToNotificationId.TryGetValue(commandHash, out notificationId))
                        {
                            ...
                            {
                                SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.AddCommandEntry|DEP> Dependency not present for commandHash, adding.");
                                dependencyList.Add(dep);
                            }
                            else
                            {
                                SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.AddCommandEntry|DEP> Dependency already present for commandHash.");
                            }
                        }
                        else
                        {
                            ...
                            SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.AddCommandEntry|DEP> Creating new Dependencies list for commandHash.");
        ...
        internal void InvalidateCommandID(SqlNotification sqlNotification)
        {
            ...
            try
            {
                ...
                lock (this)
                {
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.InvalidateCommandID|DEP> commandHash found in hashtable.");
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.InvalidateCommandID|DEP> commandHash NOT found in hashtable.");
                    }
                }
                ...
                if (null != dependencyList)
                {
                    ...
                    foreach (SqlDependency dependency in dependencyList)
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.InvalidateCommandID|DEP> Dependency found in commandHash dependency ArrayList - calling invalidate.");
                        try
                        {
        ...
        internal SqlDependency LookupDependencyEntry(string id)
        {
            ...
            try
            {
                ...
                lock (this)
                {
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.LookupDependencyEntry|DEP|ERR> ERROR - dependency ID mismatch - not throwing.");
                    }
                }
        ...
        private void LookupDependencyEntryWithRemove(string id)
        {
            ...
            try
            {
                lock (this)
                {
                    if (_dependencyIdToDependencyHash.ContainsKey(id))
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.LookupDependencyEntryWithRemove|DEP> Entry found in hashtable - removing.");
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.LookupDependencyEntryWithRemove|DEP> Entry NOT found in hashtable.");
                    }
                }
            }
            finally
        ...
        private List<SqlDependency> LookupCommandEntryWithRemove(string notificationId)
        {
            ...
            try
            {
                ...
                lock (this)
                {
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.LookupDependencyEntriesWithRemove|DEP> Entries found in hashtable - removing.");
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.LookupDependencyEntriesWithRemove|DEP> Entries NOT found in hashtable.");
                    }
