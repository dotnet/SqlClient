            ...
            for (int i = 0; i < md.Length; i++)
            {
                ...
                else if (_typeSystem != SqlConnectionString.TypeSystem.SQLServer2000)
                {
                    ...
                    { // Additional metadata for UDTs.
                        Debug.Assert(Connection.IsSql2005OrNewer, "Invalid Column type received from the server");
                    ...
                    { // Additional metadata for Xml.
                        Debug.Assert(Connection.IsSql2005OrNewer, "Invalid DataType (Xml) for the column");
