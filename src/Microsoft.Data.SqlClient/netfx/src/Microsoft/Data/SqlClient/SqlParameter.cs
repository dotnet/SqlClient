...
namespace Microsoft.Data.SqlClient
{
    ...
    public sealed partial class SqlParameter : DbParameter, IDbDataParameter, ICloneable
    {
        ...
        /// 
        /// </summary>
        [ResCategoryAttribute(StringsHelper.ResourceNames.DataCategory_Xml), ResDescriptionAttribute(StringsHelper.ResourceNames.SqlParameter_XmlSchemaCollectionDatabase),]
        ...
        [ResCategoryAttribute(StringsHelper.ResourceNames.DataCategory_Xml), ResDescriptionAttribute(StringsHelper.ResourceNames.SqlParameter_XmlSchemaCollectionOwningSchema),]
        ...
        /// 
        /// </summary>
        [ResCategoryAttribute(StringsHelper.ResourceNames.DataCategory_Xml), ResDescriptionAttribute(StringsHelper.ResourceNames.SqlParameter_XmlSchemaCollectionName),]
        ...
        [DefaultValue(false), ResCategoryAttribute(StringsHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(StringsHelper.ResourceNames.TCE_SqlParameter_ForceColumnEncryption),]
        ...
        private SqlMetaData MetaData
        {
            get
            {
                ...
                {
                    maxlen = SmiMetaData.GetDefaultForType(mt.SqlDbType).MaxLength;
                }
        ...
        internal bool IsNull
        {
            get
            {
                ...
                if (_internalMetaType.SqlDbType == System.Data.SqlDbType.Udt)
                {
                    _isNull = ((_value == null) || (_value == DBNull.Value) || ((_isSqlParameterSqlType) && (_valueAsINullable.IsNull)));
                }
                return _isNull;
        ...
        internal int GetActualSize()
        {
            ...
            if ((_actualSize == -1) || (actualType == System.Data.SqlDbType.Udt))
            {
                _actualSize = 0;
        ...
        internal object GetCoercedValue()
        {
            ...
            if ((null == _coercedValue) || (_internalMetaType.SqlDbType == System.Data.SqlDbType.Udt))
        ...
        // UNDONE TODO BUG - most likely this is temporary until we can remove 3 part names.
