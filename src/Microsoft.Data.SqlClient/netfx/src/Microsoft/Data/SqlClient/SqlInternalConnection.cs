...
namespace Microsoft.Data.SqlClient
{
    abstract internal class SqlInternalConnection : DbConnectionInternal
    {
        ...
        abstract internal bool IsSql2000
        {
            get;
        }

        abstract internal bool IsSql2005OrNewer
        {
            get;
        }
        ...
        private void EnlistNonNull(SysTx.Transaction tx)
        {
            ...
            Debug.Assert(!IsSql2005OrNewer || null != CurrentTransaction, "delegated/enlisted transaction with null current transaction?");
        }
        ...
        internal void EnlistNull()
        {
            ...
            Debug.Assert(!IsSql2005OrNewer || null == CurrentTransaction, "unenlisted transaction with non-null current transaction?");   // verify it!
        }
