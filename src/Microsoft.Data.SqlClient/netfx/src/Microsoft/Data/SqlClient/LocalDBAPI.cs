                    ...
                    try
                    {
                        ...
                        if (s_userInstanceDLLHandle == IntPtr.Zero)
                        {
                            ...
                            if (s_userInstanceDLLHandle != IntPtr.Zero)
                            {
                                ...
                                {
                                    SqlClientEventSource.Log.Trace("<sc.LocalDBAPI.UserInstanceDLLHandle> LocalDB - handle obtained");
                                }
                            }
                            else
                            {
                ...
                try
                {
                    ...
                    if (s_configurableInstances == null)
                    {
                        ...
                        else
                        {
                            if (SqlClientEventSource.Log.IsTraceEnabled())
                            {
                                SqlClientEventSource.Log.Trace("<sc.LocalDBAPI.CreateLocalDBInstance> No system.data.localdb section found in configuration");
                            }
                        }
