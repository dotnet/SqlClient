...
namespace Microsoft.Data {
    ...
    public class ForeignKeyConstraint : Constraint {
        ...
        ///       child <see cref='Microsoft.Data.DataColumn'/> objects.
        ///    </para>
        /// </devdoc>
        ...
        ///       parent and child <see cref='Microsoft.Data.DataColumn'/> objects.
        ///    </para>
        /// </devdoc>
        ...
        ///       of parent and child <see cref='Microsoft.Data.DataColumn'/> objects.
        ///    </para>
        /// </devdoc>
        ...
        ///    <para>
        ///       Initializes a new instance of the <see cref='System.Data.ForeignKeyConstraint'/> class with the specified name,
        ///       and arrays of parent and child <see cref='Microsoft.Data.DataColumn'/> objects.
        ///    </para>
        /// </devdoc>
...
//            ForeignKeyConstraint(constraintName, parentTableName, null, parentColumnNames, childColumnNames,acceptRejectRule, deleteRule, updateRule)
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.ForeignKeyConstraintChildColumnsDescr),
        ReadOnly(true)
        ]
            ...
            for (int i = 0; i < uniqueChildKeys.Length; i++) {
                ...
                if (!IsKeyNull(childValues)) {
                    if (!parentIndex.IsKeyInIndex(childValues)) {
                        ...
                        string error = ResHelper.GetString(Res.DataConstraint_ForeignKeyViolation, ConstraintName, ExceptionBuilder.KeysToString(childValues));
        ...
        ///       this constraint when <see cref='Microsoft.Data.DataTable.AcceptChanges'/>
        ///       is invoked.
        ///    </para>
        /// </devdoc>
        [
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.ForeignKeyConstraintAcceptRejectRuleDescr)
        ]
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.ForeignKeyConstraintDeleteRuleDescr)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.ForeignKeyConstraintParentColumnsDescr),
        ReadOnly(true)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.ForeignKeyRelatedTableDescr),
        ReadOnly(true)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(Rule_Default),
        ResDescriptionAttribute(ResHelper.ResourceNames.ForeignKeyConstraintUpdateRuleDescr)
        ]
