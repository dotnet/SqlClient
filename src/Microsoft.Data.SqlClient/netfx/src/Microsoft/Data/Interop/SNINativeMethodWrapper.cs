...
namespace Microsoft.Data.SqlClient
{
    internal static class SNINativeMethodWrapper
    {
        ...
        internal static uint SNIWaitForSSLHandshakeToComplete([In] SNIHandle pConn, int dwMilliseconds, out uint dwProtocolVersion)
        {
            return s_is64bitProcess ?
                SNINativeManagedWrapperX64.SNIWaitForSSLHandshakeToComplete(pConn, dwMilliseconds, out dwProtocolVersion) :
                SNINativeManagedWrapperX86.SNIWaitForSSLHandshakeToComplete(pConn, dwMilliseconds, out dwProtocolVersion);
        }
