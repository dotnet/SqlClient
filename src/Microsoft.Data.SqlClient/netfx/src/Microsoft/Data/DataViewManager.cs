...
namespace Microsoft.Data {
    ...
    public class DataViewManager : MarshalByValueComponent, IBindingList, System.ComponentModel.ITypedList {
        ...
        [
        DefaultValue(null),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewManagerDataSetDescr)
        ]
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewManagerTableSettingsDescr)
        ]
        ...
        */
        ...
        protected virtual void TableCollectionChanged(object sender, CollectionChangeEventArgs e) {
             ...
             OnListChanged(
                 e.Action == CollectionChangeAction.Add ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorAdded, new DataTablePropertyDescriptor((Microsoft.Data.DataTable)e.Element)) :
                 e.Action == CollectionChangeAction.Refresh ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorChanged, NullProp) :
                 e.Action == CollectionChangeAction.Remove ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorDeleted, new DataTablePropertyDescriptor((Microsoft.Data.DataTable)e.Element)) :
                 /*default*/ null
             );
        }
