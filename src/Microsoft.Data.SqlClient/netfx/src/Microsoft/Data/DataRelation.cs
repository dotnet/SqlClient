...
namespace Microsoft.Data {
    ...
    public class DataRelation {
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of the <see cref='Microsoft.Data.DataRelation'/> class using the specified name,
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of the <see cref='Microsoft.Data.DataRelation'/> class using the specified name, parent, and child columns, and
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of the <see cref='Microsoft.Data.DataRelation'/> class using the specified name, matched arrays of parent
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataRelationChildColumnsDescr)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataRelationParentColumnsDescr)
        ]
        ...
        ///       data set's <see cref='Microsoft.Data.DataRelationCollection'/>.
        ///    </para>
        /// </devdoc>
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataRelationRelationNameDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataRelationNested)
        ]
