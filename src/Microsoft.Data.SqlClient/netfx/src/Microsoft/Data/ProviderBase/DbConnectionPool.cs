...
namespace Microsoft.Data.ProviderBase
{
    ...
    sealed internal class DbConnectionPool
    {
        ...
        sealed private class TransactedConnectionPool
        {
            ...
            internal TransactedConnectionPool(DbConnectionPool pool)
            {
                ...
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.TransactedConnectionPool|RES|CPOOL> {ObjectID}#, Constructed for connection pool {_pool.ObjectID}#");
            }
            ...
            internal DbConnectionInternal GetTransactedObject(SysTx.Transaction transaction)
            {
                ...
                {
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.GetTransactedObject|RES|CPOOL> { ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Popped.");
                }
                ...
                lock (_transactedCxns)
                {
                    ...
                    if (txnFound = _transactedCxns.TryGetValue(transaction, out connections))
                    {
                        ...
                        lock (connections)
                        {
                            ...
                            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.PutTransactedObject|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Pushing.");
                ...
                if (!txnFound)
                {
                    ...
                    try
                    {
                        ...
                        lock (_transactedCxns)
                        {
                            ...
                            {
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.PutTransactedObject|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Adding List to transacted pool.");
                    ...
                    if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                        SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.PutTransactedObject|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Added.");
                }
            ...
            {
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.TransactionEnded|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Transaction Completed");
                ...
                lock (_transactedCxns)
                {
                    if (_transactedCxns.TryGetValue(transaction, out connections))
                    {
                        ...
                        lock (connections)
                        {
                            ...
                            {
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.TransactionEnded|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Removing List from transacted pool.");
                    ...
                    else
                    {
                        ...
                        if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                            SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactedConnectionPool.TransactionEnded|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Transacted pool not yet created prior to transaction completing. Connection may be leaked.");
                    }
                }
                            ...
                            DbConnectionPoolProviderInfo connectionPoolProviderInfo)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.DbConnectionPool|RES|CPOOL> {ObjectID}#, Constructed.");
        ...
        private void CleanupCallback(Object state)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.CleanupCallback|RES|INFO|CPOOL> {ObjectID}#");
            ...
            if (_waitHandles.PoolSemaphore.WaitOne(0, false) /* != WAIT_TIMEOUT */)
            {
                for (; ; )
                {
                    ...
                    if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                        SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.CleanupCallback|RES|INFO|CPOOL> {ObjectID}#, ChangeStacks={obj.ObjectID}#");
        ...
        {
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.Clear|RES|CPOOL> {ObjectID}#, Clearing.");
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.Clear|RES|CPOOL> {ObjectID}#, Cleared.");
        }
        ...
        private DbConnectionInternal CreateObject(DbConnection owningObject, DbConnectionOptions userOptions, DbConnectionInternal oldConnection)
        {
            ...
            try
            {
                ...
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.CreateObject|RES|CPOOL> {ObjectID}#, Connection {newObj.ObjectID}#, Added to pool.");
        ...
        {
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.DeactivateObject|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Deactivating.");
        ...
        internal void DestroyObject(DbConnectionInternal obj)
        {
            ...
            {
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.DestroyObject|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Has Delegated Transaction, waiting to Dispose.");
            }
            else
            {
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.DestroyObject|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Removing from pool.");
                ...
                if (removed)
                {
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.DestroyObject|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Removed from pool.");
                    PerformanceCounters.NumberOfPooledConnections.Decrement();
                }
                obj.Dispose();

                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.DestroyObject|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Disposed.");
        ...
        {
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.ErrorCallback|RES|CPOOL> {ObjectID}#, Resetting Error handling.");
        ...
        internal bool TryGetConnection(DbConnection owningObject, TaskCompletionSource<DbConnectionInternal> retry, DbConnectionOptions userOptions, out DbConnectionInternal connection)
        {
            ...
            {
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, DbConnectionInternal State != Running.");
                connection = null;
                return true;
            }
        ...
        private bool TryGetConnection(DbConnection owningObject, uint waitForMultipleObjectsTimeout, bool allowCreate, bool onlyOneCheckConnection, DbConnectionOptions userOptions, out DbConnectionInternal connection)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Getting connection.");
                    ...
                    try
                    {
                        ...
                        switch (waitResult)
                        {
                            case WAIT_TIMEOUT:
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Wait timed out.");
                            ...
                            case ERROR_HANDLE:
                                ...
                                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Errors are set.");
                                Interlocked.Decrement(ref _waitCount);
                            ...
                            case CREATION_HANDLE:
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Creating new connection.");
                            ...
                            case SEMAPHORE_HANDLE:
                                ...
                                {
                                    if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                        SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, found dead and removed.");
                            ...
                            case WAIT_FAILED:
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Wait failed.\n");
                            ...
                            case (WAIT_ABANDONED + SEMAPHORE_HANDLE):
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Semaphore handle abandonded.");
                            ...
                            case (WAIT_ABANDONED + ERROR_HANDLE):
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Error handle abandonded.");
                            ...
                            case (WAIT_ABANDONED + CREATION_HANDLE):
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, Creation handle abandoned.");
                            ...
                            default:
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetConnection|RES|CPOOL> {ObjectID}#, WaitForMultipleObjects={waitResult}");
        ...
        internal DbConnectionInternal ReplaceConnection(DbConnection owningObject, DbConnectionOptions userOptions, DbConnectionInternal oldConnection)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.ReplaceConnection|RES|CPOOL> {ObjectID}#, replacing connection.");
        ...
        private DbConnectionInternal GetFromGeneralPool()
        {
            ...
            {
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetFromGeneralPool|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Popped from general pool.");
        ...
        private DbConnectionInternal GetFromTransactedPool(out SysTx.Transaction transaction)
        {
            ...
            if (null != transaction && null != _transactedConnectionPool)
            {
                ...
                {
                    if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                        SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetFromTransactedPool|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Popped from transacted pool.");
                    ...
                    if (obj.IsTransactionRoot)
                    {
                        ...
                        {
                            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.GetFromTransactedPool|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, found dead and removed.");
        ...
        private void PoolCreateRequest(object state)
        {
            ...
            {
                scopeID = SqlClientEventSource.Log.PoolerScopeEnter($"<prov.DbConnectionPool.PoolCreateRequest|RES|INFO|CPOOL> {ObjectID}#");
            }
                        ...
                        if (NeedToReplenish)
                        {
                            ...
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                        SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.PoolCreateRequest|RES|CPOOL> {ObjectID}#, PoolCreateRequest called WaitForSingleObject failed {waitResult}");
                                }
                            }
                            catch (Exception e)
                            {
                                ...
                                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.PoolCreateRequest|RES|CPOOL> {ObjectID}#, PoolCreateRequest called CreateConnection which threw an exception: {e}");
                            }
                            finally
                            {
                                if (WAIT_OBJECT_0 == waitResult)
        ...
        internal void PutNewObject(DbConnectionInternal obj)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.PutNewObject|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Pushing to general pool.");
        ...
        internal void PutObjectFromTransactedPool(DbConnectionInternal obj)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.PutObjectFromTransactedPool|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Transaction has ended.");
        ...
        private bool ReclaimEmancipatedObjects()
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.ReclaimEmancipatedObjects|RES|CPOOL> {ObjectID}#");
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                    SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.ReclaimEmancipatedObjects|RES|CPOOL> {ObjectID}#, Connection {obj.ObjectID}#, Reclaiming.");
        ...
        {
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.Startup|RES|INFO|CPOOL> {ObjectID}#, CleanupWait={_cleanupWait}");
        ...
        {
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.Shutdown|RES|INFO|CPOOL> {ObjectID}#\n");
        ...
        internal void TransactionEnded(SysTx.Transaction transaction, DbConnectionInternal transactedObject)
        {
            ...
            if (SqlClientEventSource.Log.IsPoolerTraceEnabled())
                SqlClientEventSource.Log.PoolerTrace($"<prov.DbConnectionPool.TransactionEnded|RES|CPOOL> {ObjectID}#, Transaction {transaction.GetHashCode()}#, Connection {transactedObject.ObjectID}#, Transaction Completed");
