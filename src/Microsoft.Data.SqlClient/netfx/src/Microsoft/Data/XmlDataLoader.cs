...
*/
        ...
        private void LoadTable(DataTable table, bool isNested ) {
            ...
            for ( int i = dataReader.AttributeCount -1; i >= 0; --i) {    
                ...
                // BUGBUG: Desktop ignores this attribute as described in SQL BU Bug #186716: 
                // In DataSet, xsi:nil="true" is being ignored if content is not empty
                // Thus, we do nothing. Uncomment if this bug is approved.
