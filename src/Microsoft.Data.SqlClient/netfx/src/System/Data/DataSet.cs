...
namespace Microsoft.Data {
    ...
    /// </devdoc>
    [
    ResDescriptionAttribute(ResHelper.ResourceNames.DataSetDescr),
 ...
 public class DataSet : MarshalByValueComponent, System.ComponentModel.IListSource, IXmlSerializable, ISupportInitializeNotification, ISerializable {
        ...
        */
        ...
        ///       comparisons within <see cref='Microsoft.Data.DataTable'/>
        ///       objects are
        ///       case-sensitive.
        ///    </para>
        /// </devdoc>
        ...
        DefaultValue(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetCaseSensitiveDescr)
        ]
        ...
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataSetDefaultViewDescr)]
        ...
        /// </devdoc>
        [DefaultValue(true), ResDescriptionAttribute(ResHelper.ResourceNames.DataSetEnforceConstraintsDescr)]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetDataSetNameDescr)
        ]
        ...
        DefaultValue(""),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetNamespaceDescr)
        ]
        ...
        DefaultValue(""),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetPrefixDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataSetHasErrorsDescr)]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetLocaleDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetRelationsDescr)
        ]
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataSetTablesDescr)
        ]
        ...
        [
         ...
         ResDescriptionAttribute(ResHelper.ResourceNames.DataSetMergeFailedDescr)
        ]
        ...
        /// <devdoc>
        /// <para>Clones the structure of the <see cref='System.Data.DataSet'/>, including all <see cref='Microsoft.Data.DataTable'/> schemas, relations, and
        ///    constraints.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Merges this <see cref='Microsoft.Data.DataTable'/> into a specified <see cref='Microsoft.Data.DataTable'/>.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Merges this <see cref='Microsoft.Data.DataTable'/> into a specified <see cref='Microsoft.Data.DataTable'/>. with a value to preserve changes
 ...
 public class DataSetSchemaImporterExtension : SchemaImporterExtension {
        ...
        internal string GenerateTypedDataSet(XmlSchemaElement element, XmlSchemas schemas, CodeNamespace codeNamespace, StringCollection references, CodeDomProvider codeProvider) {
            ...
            // UNDONE TypedDataSetGenerator needs to provide a way to generate classes from XmlSchemas collection
