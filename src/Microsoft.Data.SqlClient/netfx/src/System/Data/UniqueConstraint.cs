...
namespace Microsoft.Data {
    ...
    public class UniqueConstraint : Constraint {
        ...
        /// <see cref='Microsoft.Data.DataColumn'/>.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        /// <para>Initializes a new instance of the <see cref='System.Data.UniqueConstraint'/> with the specified <see cref='Microsoft.Data.DataColumn'/>.</para>
        /// </devdoc>
        ...
        ///    of <see cref='Microsoft.Data.DataColumn'/> objects.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of the <see cref='System.Data.UniqueConstraint'/> with the given array of <see cref='Microsoft.Data.DataColumn'/>
        ///       objects.
        ///    </para>
        /// </devdoc>
        ...
        internal override bool IsConstraintViolated() {
            ...
            if (index.HasDuplicates) {
                // TODO: SQLBU 441014 iterate over index instead of copy all unique keys only to search for them
                ...
                for (int i = 0; i < uniqueKeys.Length; i++) {
                    ...
                    if (1 < r.Count) {
                        ...
                        for (int j = 0; j < rows.Length; j++) {
                            // CONSIDER: SQLBU 441249 to append, not replace existing error messages
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.KeyConstraintColumnsDescr),
        ReadOnly(true)
        ]
        ...
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.KeyConstraintIsPrimaryKeyDescr)
        ]
