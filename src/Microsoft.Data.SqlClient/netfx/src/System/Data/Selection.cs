...
// old and existing DeleteRecord behavior, we can not use this for silently deleting
        ...
        // TODO: Change in behaviour: public method of an internal class: GetIndex will return -1 if specified record not found instead
        // of the probable record position with the MSB set (i.e. ored with 0x7fffffff)
