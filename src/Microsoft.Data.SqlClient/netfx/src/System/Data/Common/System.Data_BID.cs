...
// <owner current="true" primary="false">nissimn</owner>
//-----------------------------------------------------------------------------------------------
...
internal static partial class Bid
{
    ...
    //[BidMethod]
    //[ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)]
    //internal static void Trace(string fmtPrintfW, Microsoft.Data.OleDb.OleDbHResult a1) { // TODO: rename to TraceHResult
    //    if (((Microsoft.Data.OleDb.OleDbHResult.S_OK != a1) ||  (modFlags & ApiGroup.StatusOk) != 0) &&  (modFlags & ApiGroup.Trace) != 0  &&  modID != NoData)
    //        NativeMethods.Trace (modID, UIntPtr.Zero, UIntPtr.Zero, fmtPrintfW, (int)a1);
    //}

    //[BidMethod]
    //internal static void Trace(string fmtPrintfW, Microsoft.Data.OleDb.OleDbHResult a1, System.String a2) {
    //    if ((modFlags & ApiGroup.Trace) != 0  &&  modID != NoData)
    //        NativeMethods.Trace (modID, UIntPtr.Zero, UIntPtr.Zero, fmtPrintfW, (int)a1,a2);
    //}

    //[BidMethod]
    //internal static void Trace(string fmtPrintfW, Microsoft.Data.OleDb.OleDbHResult a1, System.IntPtr a2) {
    //    if ((modFlags & ApiGroup.Trace) != 0  &&  modID != NoData)
    //        NativeMethods.Trace (modID, UIntPtr.Zero, UIntPtr.Zero, fmtPrintfW, (int)a1,a2);
    //}

    //[BidMethod]
    //internal static void Trace(string fmtPrintfW, Microsoft.Data.OleDb.OleDbHResult a1, System.Int32 a2) {
    //    if ((modFlags & ApiGroup.Trace) != 0  &&  modID != NoData)
    //        NativeMethods.Trace (modID, UIntPtr.Zero, UIntPtr.Zero, fmtPrintfW, (int)a1,a2);
    //}
