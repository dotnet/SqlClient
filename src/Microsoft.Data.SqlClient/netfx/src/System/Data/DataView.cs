...
// <owner current="true" primary="false">amirhmy</owner>
//------------------------------------------------------------------------------
using System;
...
namespace Microsoft.Data {
    /// <devdoc>
    ///    <para>
    ///       Represents a databindable, customized view of a <see cref='Microsoft.Data.DataTable'/>
    ...
    public class DataView : MarshalByValueComponent, IBindingListView , System.ComponentModel.ITypedList, ISupportInitializeNotification {
        ...
        ///    specified <see cref='Microsoft.Data.DataTable'/>.</para>
        /// </devdoc>
        ...
        DefaultValue(true),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewAllowDeleteDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewApplyDefaultSortDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(true),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewAllowEditDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(true),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewAllowNewDescr)
        ]
        ...
        /// </summary>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataViewCountDescr)]
        public int Count {
            get {
        ...
        ///    </para>
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataViewDataViewManagerDescr)]
        ...
        ///       projecting views of data on the <see cref='Microsoft.Data.DataTable'/>.
        ///    </para>
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataViewIsOpenDescr)]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewRowFilterDescr)
        ]
        ...
        /// <summary></summary>
        private sealed class RowPredicateFilter : Microsoft.Data.IFilter {
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewRowStateFilterDescr)
        ]
        ...
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        DefaultValue(""),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewSortDescr)
        ]
        public string Sort {
            get {
...
// this is dead code, no one is calling it
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets or sets the source <see cref='Microsoft.Data.DataTable'/>.
        ///    </para>
        /// </devdoc>
        [
        ...
        DefaultValue(null),
        RefreshProperties(RefreshProperties.All),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataViewTableDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataViewListChangedDescr)]
        ...
        [
            ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Action),
            ResDescriptionAttribute(ResHelper.ResourceNames.DataSetInitializedDescr)
        ]
        ...
        internal void ChildRelationCollectionChanged(object sender, CollectionChangeEventArgs e) {
            ...
            OnListChanged(
                e.Action == CollectionChangeAction.Add ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorAdded, new DataRelationPropertyDescriptor((Microsoft.Data.DataRelation)e.Element)) :
                e.Action == CollectionChangeAction.Refresh ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorChanged, NullProp):
                e.Action == CollectionChangeAction.Remove ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorDeleted, new DataRelationPropertyDescriptor((Microsoft.Data.DataRelation)e.Element)) :
            /*default*/ null
            );
        }
        ...
        protected virtual void ColumnCollectionChanged(object sender, CollectionChangeEventArgs e) {
            ...
            OnListChanged(
                e.Action == CollectionChangeAction.Add ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorAdded, new DataColumnPropertyDescriptor((Microsoft.Data.DataColumn)e.Element)) :
                e.Action == CollectionChangeAction.Refresh ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorChanged, NullProp):
                e.Action == CollectionChangeAction.Remove ? new ListChangedEventArgs(ListChangedType.PropertyDescriptorDeleted, new DataColumnPropertyDescriptor((Microsoft.Data.DataColumn)e.Element)) :
                /*default*/ null
            );
        }
