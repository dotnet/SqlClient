...
//        private bool serializeHierarchy = false;
        ...
        /// <devdoc>
        /// <para>Initializes a new instance of the <see cref='Microsoft.Data.DataTable'/> class with no arguments.</para>
        /// </devdoc>
        public DataTable() {
        ...
        /// <devdoc>
        /// <para>Intitalizes a new instance of the <see cref='Microsoft.Data.DataTable'/> class with the specified table
        ///    name.</para>
        /// </devdoc>
...
//        Set the row and columns in error..
        ...
        /// </devdoc>
        [ResDescriptionAttribute(ResHelper.ResourceNames.DataTableCaseSensitiveDescr)]
...
// used to keep temporary state of unique Key posiotion to be added for inference only
        ...
        /// <devdoc>
        /// <para>Gets the collection of child relations for this <see cref='Microsoft.Data.DataTable'/>.</para>
        /// </devdoc>
        [
        Browsable(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableChildRelationsDescr),
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableColumnsDescr)
        ]
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableConstraintsDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Resets the <see cref='Microsoft.Data.DataTable.Constraints'/> property to its default state.
        ///    </para>
        /// </devdoc>
        ...
        /// </devdoc>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableDataSetDescr)]
        ...
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableDefaultViewDescr)]
        ...
        DefaultValue(""),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableDisplayExpressionDescr)
        ]
        ...
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableHasErrorsDescr)]
        ...
        /// </devdoc>
        [ResDescriptionAttribute(ResHelper.ResourceNames.DataTableLocaleDescr)]
        ...
        DefaultValue(50),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableMinimumCapacityDescr)
        ]
        ...
        /// <devdoc>
        /// <para>Gets the collection of parent relations for this <see cref='Microsoft.Data.DataTable'/>.</para>
        /// </devdoc>
        [
        Browsable(false),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableParentRelationsDescr),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)
        ]
        ...
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTablePrimaryKeyDescr),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ...
        /// <devdoc>
        ///    <para>
        ///       Indicates whether the <see cref='Microsoft.Data.DataTable.PrimaryKey'/> property should be persisted.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Resets the <see cref='Microsoft.Data.DataTable.PrimaryKey'/> property to its default state.
        ///    </para>
        /// </devdoc>
        ...
        /// </devdoc>
        [Browsable(false), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowsDescr)]
        ...
        DefaultValue(""),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableTableNameDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets or sets the namespace for the <see cref='Microsoft.Data.DataTable'/>.
        ///    </para>
        /// </devdoc>
        [
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableNamespaceDescr)
        ]
        ...
        /// <devdoc>
        ///    <para>
        ///       Indicates whether the <see cref='Microsoft.Data.DataTable.Namespace'/> property should be persisted.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Resets the <see cref='Microsoft.Data.DataTable.Namespace'/> property to its default state.
        ///    </para>
        /// </devdoc>
        ...
        DefaultValue(""),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTablePrefixDescr)
        ]
        ...
        /// <devdoc>
        /// <para>Commits all the changes made to this table since the last time <see cref='Microsoft.Data.DataTable.AcceptChanges'/> was called.</para>
        /// </devdoc>
...
//            clone.SerializeHierarchy = SerializeHierarchy;
        ...
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableColumnChangingDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableColumnChangedDescr)]
        ...
        ///    </para>
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowChangedDescr)]
        ...
        ///    </para>
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowChangingDescr)]
        ...
        ///    </para>
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowDeletingDescr)]
        ...
        ///    </para>
        /// </devdoc>
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowDeletedDescr)]
        ...
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowsClearingDescr)]
        ...
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowsClearedDescr)]
        ...
        [ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data), ResDescriptionAttribute(ResHelper.ResourceNames.DataTableRowsNewRowDescr)]
        ...
        /// <devdoc>
        /// <para>Notifies the <see cref='Microsoft.Data.DataTable'/> that a <see cref='Microsoft.Data.DataColumn'/> is
        ///    being removed.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Raises the <see cref='Microsoft.Data.DataTable.RowChanged'/> event.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Raises the <see cref='Microsoft.Data.DataTable.RowChanging'/> event.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Raises the <see cref='Microsoft.Data.DataTable.OnRowDeleting'/> event.
        ///    </para>
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Raises the <see cref='Microsoft.Data.DataTable.OnRowDeleted'/> event.
        ///    </para>
        /// </devdoc>
...
// IT SHOULD NOT CAUSE ANY EVENT TO BE FIRED
        ...
        ///       since it was loaded, or the last time <see cref='Microsoft.Data.DataTable.AcceptChanges'/> was called.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        /// <para>Returns the <see cref='Microsoft.Data.DataTable.TableName'/> and <see cref='Microsoft.Data.DataTable.DisplayExpression'/>, if there is one as a concatenated string.</para>
        /// </devdoc>
...
//                (action == DataRowAction.Rollback && row.tempRecord != -1));
        ...
        private void SetDataRowWithLoadOption (DataRow dataRow, int recordNo, LoadOption loadOption, bool checkReadOnly) {
            ...
            if (hasError) {
                string error = ResHelper.GetString(Res.Load_ReadOnlyDataModified);
...
/*
        ...
        DefaultValue(false),
        ResCategoryAttribute(ResHelper.ResourceNames.DataCategory_Data),
        ResDescriptionAttribute(ResHelper.ResourceNames.DataTableSerializeHierarchy)
        ]
