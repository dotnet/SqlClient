...
namespace Microsoft.Data.SqlClient.Reliability
{
    ...
    public class SqlThrottlingCondition
    {
        ...
        /// <summary>
        ///  Attach the decoded values as additional attributes to the original SQL exception if it has the 40501 SQL error number
        /// </summary>
        /// <param name="sqlException">The original SQL exception</param>
        public static void EnrichException(SqlException sqlException)
        {
