    ...
    internal partial class SqlAuthenticationProviderManager
    {
        ...
        static SqlAuthenticationProviderManager()
        {
            ...
            catch (ConfigurationErrorsException e)
            {
                ...
                SqlClientEventSource.Log.TryTraceEvent("Unable to load custom SqlAuthenticationProviders. ConfigurationManager failed to load due to configuration errors: {0}", e);
            }
