...
namespace Microsoft.Data.SqlClient
{
    ...
    internal abstract partial class SqlColumnEncryptionEnclaveProvider
    {
        ...
        internal abstract void CreateEnclaveSession(byte[] enclaveAttestationInfo, ECDiffieHellman clientDiffieHellmanKey, string attestationUrl, string servername, byte[] customData, int customDataLength,
