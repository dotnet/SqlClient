        ...
        private static void TimeoutTimerCallback(object state)
        {
            ...
            try
            {
                ...
                lock (SingletonInstance._instanceLock)
                {
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.TimeoutTimerCallback|DEP> No dependencies, exiting.");
                    ...
                    {
                        SqlClientEventSource.Log.NotificationTrace("<sc.SqlDependencyPerAppDomainDispatcher.TimeoutTimerCallback|DEP> No timeouts expired, exiting.");
