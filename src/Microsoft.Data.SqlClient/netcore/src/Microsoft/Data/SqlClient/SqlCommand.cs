...
namespace Microsoft.Data.SqlClient
{
    ...
    public sealed partial class SqlCommand : DbCommand, ICloneable
    {
        ...
        {
            SqlClientEventSource.Log.TryCorrelationTraceEvent("<sc.SqlCommand.InternalExecuteNonQueryAsync|API|Correlation> ObjectID {0}, ActivityID {1}", ObjectID, ActivityCorrelator.Current);
            Guid operationId = _diagnosticListener.WriteCommandBefore(this, _transaction);
        ...
        {
            SqlClientEventSource.Log.TryCorrelationTraceEvent("<sc.SqlCommand.InternalExecuteReaderAsync|API|Correlation> ObjectID {0}, behavior={1}, ActivityID {2}", ObjectID, (int)behavior, ActivityCorrelator.Current);
        ...
        {
            SqlClientEventSource.Log.TryCorrelationTraceEvent("<sc.SqlCommand.InternalExecuteScalarAsync|API|Correlation> ObjectID {0}, ActivityID {1}", ObjectID, ActivityCorrelator.Current);
        ...
        {
            SqlClientEventSource.Log.TryCorrelationTraceEvent("<sc.SqlCommand.InternalExecuteXmlReaderAsync|API|Correlation> ObjectID {0}, ActivityID {1}", ObjectID, ActivityCorrelator.Current);
            Guid operationId = _diagnosticListener.WriteCommandBefore(this, _transaction);
