...
namespace Microsoft.Data.SqlClient
{
    ...
    public delegate bool ServerCertificateValidationCallback(X509Certificate2 certificate);
    ...
    public delegate X509Certificate2 ClientCertificateRetrievalCallback();
}
