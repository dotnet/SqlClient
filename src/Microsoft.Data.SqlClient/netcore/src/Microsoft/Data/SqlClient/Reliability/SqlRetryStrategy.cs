...
namespace Microsoft.Data.SqlClient.Reliability
{
    ...
    public abstract class SqlRetryStrategy
    {
        ...
        /// </summary>
        public static readonly TimeSpan DefaultMaxBackoff = TimeSpan.FromSeconds(90.0);

        /// <summary>
        /// Represents the default minimum amount of time used when calculating the exponential delay between retries.
        /// </summary>
        public static readonly TimeSpan DefaultMinBackoff = TimeSpan.FromSeconds(8.0);
        ...
        /// </summary>
        public static readonly TimeSpan DefaultRetryIncrement = TimeSpan.FromSeconds(10.0);
        ...
        /// </summary>
        public static readonly bool DefaultFirstFastRetry = false;
