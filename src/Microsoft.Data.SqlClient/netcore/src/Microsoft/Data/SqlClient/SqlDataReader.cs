    ...
    public class SqlDataReader : DbDataReader, IDataReader, IDbColumnSchemaGenerator
    {
        ...
        internal DataTable BuildSchemaTable()
        {
            ...
            for (int i = 0; i < md.Length; i++)
            {
                ...
                if (_typeSystem <= SqlConnectionString.TypeSystem.SQLServer2005 && col.IsNew2008DateTimeType)
                {
                ...
                else if (_typeSystem != SqlConnectionString.TypeSystem.SQLServer2000)
                {
                    ...
                    { // Additional metadata for UDTs.
                        Debug.Assert(Connection.IsSql2008OrNewer, "Invalid Column type received from the server");
                    ...
                    { // Additional metadata for Xml.
                        Debug.Assert(Connection.IsSql2008OrNewer, "Invalid DataType (Xml) for the column");
        ...
        private string GetDataTypeNameInternal(_SqlMetaData metaData)
        {
            ...
            if (_typeSystem <= SqlConnectionString.TypeSystem.SQLServer2005 && metaData.IsNew2008DateTimeType)
            {
        ...
        override public DateTime GetDateTime(int i)
        {
            ...
            if (_typeSystem <= SqlConnectionString.TypeSystem.SQLServer2005 && _metaData[i].IsNew2008DateTimeType)
            {
        ...
        private T GetFieldValueFromSqlBufferInternal<T>(SqlBuffer data, _SqlMetaData metaData, bool isAsync)
        {
            ...
            else if (typeof(T) == typeof(DateTimeOffset) && dataType == typeof(DateTimeOffset) && _typeSystem > SqlConnectionString.TypeSystem.SQLServer2005 && metaData.IsNew2008DateTimeType)
            {
                return (T)(object)data.DateTimeOffset;
            }
            else if (typeof(T) == typeof(DateTime) && dataType == typeof(DateTime) && _typeSystem > SqlConnectionString.TypeSystem.SQLServer2005 && metaData.IsNew2008DateTimeType)
            {
