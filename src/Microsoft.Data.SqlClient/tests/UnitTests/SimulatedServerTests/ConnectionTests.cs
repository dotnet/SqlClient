...
namespace Microsoft.Data.SqlClient.UnitTests.SimulatedServerTests
{
    public class ConnectionTests
    {
        ...
        public void CloneCopiesSspiContextProvider()
        {
            ...
            Assert.Same(provider, ((SqlConnectionPoolKey)clone.PoolGroup.PoolKey).SspiContextProvider);
        ...
        public void CredentialSetterPreservesSspiContextProviderInPoolKey()
        {
            ...
            Assert.Same(provider, ((SqlConnectionPoolKey)conn.PoolGroup.PoolKey).SspiContextProvider);
        }
        ...
        public void ClearingOneAuthPropertyPreservesTheOthersInPoolKey()
        {
            ...
            using (SqlConnection conn = new("Data Source=localhost"))
            {
                ...
                Assert.Equal("token", ((SqlConnectionPoolKey)conn.PoolGroup.PoolKey).AccessToken);
            }
            ...
            using (SqlConnection conn = new("Data Source=localhost"))
            {
                ...
                Assert.Same(callback, ((SqlConnectionPoolKey)conn.PoolGroup.PoolKey).AccessTokenCallback);
            }
