...
namespace Microsoft.Data.SqlClient.Tests
{
    public partial class SqlConnectionTest
    {
        ...
        public void Constructor2_ConnectionString_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'invalidkeyword'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        ...
        public void ConnectionString_ConnectTimeout_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'connect timeout'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        ...
        public void ConnectionString_CommandTimeout_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'command timeout'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        ...
        public void ConnectionString_MaxPoolSize_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'max pool size'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        ...
        public void ConnectionString_MinPoolSize_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'min pool size'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        ...
        public void ConnectionString_MultipleActiveResultSets_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'multiple active result sets'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        }
        ...
        public void ConnectionString_PacketSize_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'Packet Size'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        ...
        public void ConnectionString_UserInstance_Invalid()
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.True(ex.Message.IndexOf("'user instance'", StringComparison.CurrentCultureIgnoreCase) != -1);
            Assert.Null(ex.ParamName);
        }
        ...
        public void ConnectionString_IPAddressPreference_Invalid(string value)
        {
            ...
            Assert.Null(ex.InnerException);
            Assert.NotNull(ex.Message);
            Assert.Contains("'ip address preference'", ex.Message, StringComparison.CurrentCultureIgnoreCase);
            Assert.Null(ex.ParamName);
        }
    }
}
