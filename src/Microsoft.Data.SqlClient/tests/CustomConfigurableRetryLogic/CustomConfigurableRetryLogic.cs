...
// These types have been created just to test the configurable retry logic manager in the performance tests project.
namespace ConfigurableRetryLogic.Sample
{
