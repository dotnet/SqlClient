...
namespace Microsoft.Data.SqlClient.Tests.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Removes authentication and credential properties from the connection string.
        /// The properties removed are: "Authentication", "User ID", "Password", "UID", "PWD", "Trusted_Connection", and "Integrated Security".
        /// This is useful for testing scenarios where you want to ensure that the connection string does not contain any auth-related properties.
        /// </summary>
