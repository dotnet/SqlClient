...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public static class DDAsyncTest
    {
        ...
        {
            //Fails on NetCore
            var asyncConnectionString = DataTestUtility.s_tcpConnString + ";async=true";
        ...
        {
            var conn = new SqlConnection(DataTestUtility.s_tcpConnString);
        ...
        public static void ExecuteCommand_WithSharedConnection_ShouldPerformAsyncByDefault()
        {
            ...
            using (var conn = new SqlConnection((new SqlConnectionStringBuilder(DataTestUtility.s_tcpConnString) { MultipleActiveResultSets = true }).ConnectionString))
            {
                conn.Open();
