...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests.AlwaysEncrypted.Setup
{
    public class ColumnEncryptionKey : DbObject
    {
        ...
        public ColumnEncryptionKey(string name, ColumnMasterKey columnMasterKey) : base(name)
        {
            ColumnMasterKey = columnMasterKey;
            byte[] plainTextColumnEncryptionKey = GenerateRandomBytes(KeySizeInBytes);
            byte[] encryptedColumnEncryptionKey = CreateEncryptedCek(columnMasterKey.KeyPath, Algorithm, plainTextColumnEncryptionKey);
        ...
        /// <returns></returns>
        private static byte[] CreateEncryptedCek(string masterKeyPath, string encryptionKeyAlgorithm, byte[] key)
        {
            ...
            encryptedCek = certStoreProvider.EncryptColumnEncryptionKey(masterKeyPath, encryptionKeyAlgorithm, key);
