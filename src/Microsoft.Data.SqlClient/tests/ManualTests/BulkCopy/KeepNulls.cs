...
namespace Microsoft.Data.SqlClient.ManualTests.BulkCopy
{
    ...
    public class KeepNulls
    {
        ...
        public void Test()
        {
            ...
            using Table srctable = new(destConn, "SqlBulkCopyTest_KeepNulls0", "(col1 int, col2 text, col3 text)");
            using Table dsttable = new(destConn, "SqlBulkCopyTest_KeepNulls1", "(col1 int identity(1,1), col2 text default 'Jogurt', col3 text)");
            ...
            using SqlCommand srccmd = new("select * from " + srctable.Name, sourceConn);
