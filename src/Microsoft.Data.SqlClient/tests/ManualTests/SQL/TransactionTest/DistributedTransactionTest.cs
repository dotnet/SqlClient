...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    ...
    public class DistributedTransactionTest
    {
        ...
        public async Task Delegated_transaction_deadlock_in_SinglePhaseCommit()
        {
            ...
            await using var conn = DataTestUtility.GetSqlConnection(DataTestUtility.TCPConnectionString);
            ...
            await using var conn2 = DataTestUtility.GetSqlConnection(DataTestUtility.TCPConnectionString);
