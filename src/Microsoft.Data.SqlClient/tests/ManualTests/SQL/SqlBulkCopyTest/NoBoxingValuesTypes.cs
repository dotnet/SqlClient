...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public class NoBoxingValueTypes : IDisposable
    {
        ...
        static NoBoxingValueTypes()
        {
            ...
            // It would've been great to use mgravell/FastMember here to make thing logic much cleaner and not have to include the custom reader
            // however, that package is not available on the dotnet-public Nuget source, which is a bummer.
