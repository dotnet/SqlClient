    ...
    public static class DateTimeVariantTest
    {
        ...
        private static void _TestSimpleParameter_Variant(object paramValue, string expectedTypeName, string expectedBaseTypeName, string connStr, string tag) {
            ...
            try {
                ...
                {
                    dr.Read();
                    VerifyReaderTypeAndValue("Test Simple Parameter [Variant Type]", dr, expectedTypeName, expectedBaseTypeName, paramValue);
                }
            }
            finally
            {
        ...
        private static void _TestSqlDataRecordParameterToTVP_Variant(object paramValue, string expectedTypeName, string expectedBaseTypeName, string connStr, string tag) {
            ...
            try {
                ...
                {
                    dr.Read();
                    VerifyReaderTypeAndValue("Test SqlDataRecord Parameter To TVP [Variant Type]", dr, expectedTypeName, expectedBaseTypeName, paramValue);
                }
            }
            finally
            {
            ...
            try {
                ...
                using (SqlConnection connInput = new(connStr))
                {
                    ...
                    using (SqlCommand cmdInput = connInput.CreateCommand())
                    {
                        ...
                        {
                            dr.Read();
                            VerifyReaderTypeAndValue("Test SqlDataReader Parameter To TVP [Variant Type]", dr, expectedTypeName, expectedBaseTypeName, paramValue);
                        }
                    }
                }
            }
            ...
            try
            {
                ...
                using (SqlConnection conn2 = new(connStr))
                {
                    ...
                    using (SqlCommand cmd2 = new(ProcName, conn2))
                    {
                        ...
                        {
                            dr.Read();
                            VerifyReaderTypeAndValue("Test SqlDataReader TVP [Variant Type]", dr, expectedTypeName, expectedBaseTypeName, paramValue);
                        }
                    }
                }
            }
        ...
        private static void _TestSimpleDataReader_Variant(object paramValue, string expectedTypeName, string expectedBaseTypeName, string connStr, string tag) {
            ...
            try
            {
                ...
                {
                    dr.Read();
                    VerifyReaderTypeAndValue("Test Simple Data Reader [Variant Type]", dr, expectedTypeName, expectedBaseTypeName, paramValue);
                }
            }
            finally
            {
                ...
                using (SqlConnection connInput = new(connStr))
                {
                    ...
                    using (SqlCommand cmdInput = connInput.CreateCommand())
                    {
                        ...
                        using SqlDataReader drInput = cmdInput.ExecuteReader();
                        {
                            ...
                            {
                                drVerify.Read();
                                VerifyReaderTypeAndValue("SqlBulkCopy From SqlDataReader [Variant Type]", drVerify, expectedTypeName, expectedBaseTypeName, paramValue);
                            }
                        }
                    }
                }
        ...
        private static void _SqlBulkCopyDataTable_Variant(object paramValue, string expectedTypeName, string expectedBaseTypeName, string connStr, string tag) {
            ...
            try
            {
                ...
                {
                    drVerify.Read();
                    VerifyReaderTypeAndValue("SqlBulkCopy From Data Table [Variant Type]", drVerify, expectedTypeName, expectedBaseTypeName, paramValue);
                }
            }
            finally
            {
        ...
        private static void _SqlBulkCopyDataRow_Variant(object paramValue, string expectedTypeName, string expectedBaseTypeName, string connStr, string tag) {
            ...
            try
            {
                ...
                {
                    drVerify.Read();
                    VerifyReaderTypeAndValue("SqlBulkCopy From Data Row [Variant Type]", drVerify, expectedTypeName, expectedBaseTypeName, paramValue);
                }
            }
            finally
            {
        ...
        private static void VerifyReaderTypeAndValue(string tag, SqlDataReader dr, string expectedTypeName, string expectedBaseTypeName, object expectedValue)
        {
