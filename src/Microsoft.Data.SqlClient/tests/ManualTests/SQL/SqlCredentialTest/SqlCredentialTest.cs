    ...
    public static class SqlCredentialTest
    {
        ...
        public static void CreateSqlConnectionWithCredential()
        {
            ...
            try
            {
                ...
                var csb = new SqlConnectionStringBuilder(DataTestUtility.s_tcpConnString);
                csb.Remove("User ID");
                csb.Remove("Password");
        ...
        public static void OldCredentialsShouldFail()
        {
            ...
            try
            {
                ...
                SqlConnectionStringBuilder sqlConnectionStringBuilder = new SqlConnectionStringBuilder(DataTestUtility.s_tcpConnString);
        ...
        private static void createTestUser(string username, string password)
        {
            ...
            using (var conn = new SqlConnection(DataTestUtility.s_tcpConnString))
