...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests.SQL.VectorTest
{
    ...
    public sealed class Float16VectorTypeBackwardCompatibilityTests : IDisposable
    {
        private readonly ITestOutputHelper _output;
        private static readonly string s_connectionString = DataTestUtility.TCPConnectionString;
        private static readonly string s_tableName = DataTestUtility.GetShortName("VectorF16TestTable");
        private static readonly string s_bulkCopySrcTableName = DataTestUtility.GetShortName("VectorF16BulkCopyTestTable");
        private static readonly string s_bulkCopySrcTableDef = $@"(Id INT PRIMARY KEY IDENTITY, VectorData varchar(max) NULL)";
        private static readonly string s_tableDefinition = $@"(Id INT PRIMARY KEY IDENTITY, VectorData vector(3, float16) NULL)";
        ...
        private static readonly string s_storedProcName = DataTestUtility.GetShortName("VectorF16AsVarcharSp");
        private static readonly string s_storedProcBody = $@"
                ...
                -- Insert into vector(float16) table
        ...
        /// Mirrors the 4 parameter construction patterns tested for the float32 backward
        /// compatibility path.
        /// </summary>
        ...
        {
            float[] data = Float16VarcharVectorTestData.TestData;
        ...
        {
            float[] testData = Float16VarcharVectorTestData.TestData;
        ...
        public void TestInsertVectorsAsVarcharWithPrepare()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                // Use whole-number values that are exactly representable in float16.
            ...
            while (reader.Read())
            {
                float[] expectedData = new float[] { rowcnt + 1, rowcnt + 2, rowcnt + 3 };
