...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public static class ExceptionTest
    {
        ...
        public static void WarningTest()
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection((new SqlConnectionStringBuilder(DataTestUtility.s_tcpConnString) { Pooling = false }).ConnectionString))
            {
        ...
        {
            if (DataTestUtility.s_tcpConnString == null)
                return false;

            using (SqlConnection conn = new SqlConnection(DataTestUtility.s_tcpConnString))
        ...
        public static void WarningsBeforeRowsTest()
        {
            ...
            SqlInfoMessageEventHandler handler = new SqlInfoMessageEventHandler(warningCallback);
            SqlConnection sqlConnection = new SqlConnection(DataTestUtility.s_tcpConnString);
            sqlConnection.InfoMessage += handler;
            sqlConnection.Open();
        ...
        public static async Task UnobservedTaskExceptionTest()
        {
            ...
            using (var connection = new SqlConnection(DataTestUtility.s_tcpConnString))
            {
