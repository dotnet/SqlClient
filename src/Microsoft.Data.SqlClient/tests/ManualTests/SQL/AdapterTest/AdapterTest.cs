...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public class AdapterTest
    {
        ...
        public void PrepUnprepTest()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("select * from shippers", new SqlConnection(DataTestUtility.s_tcpConnString)))
        ...
        public void SqlVariantTest()
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand(null, new SqlConnection(DataTestUtility.s_tcpConnString)))
                using (SqlDataAdapter sqlAdapter = new SqlDataAdapter())
                {
                    cmd.Connection.Open();
        ...
        {
            // Test exceptions
            using (SqlDataAdapter sqlAdapter = new SqlDataAdapter(new SqlCommand("select * from orders", new SqlConnection(DataTestUtility.s_tcpConnString))))
            {
                DataSet dataset = new DataSet();
