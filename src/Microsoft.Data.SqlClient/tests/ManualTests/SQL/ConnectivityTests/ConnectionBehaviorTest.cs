...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public class ConnectionBehaviorTest
    {
        ...
        {
            using (SqlConnection sqlConnection = DataTestUtility.GetSqlConnection((new SqlConnectionStringBuilder(DataTestUtility.TCPConnectionString) { MaxPoolSize = 1 }).ConnectionString))
            {
