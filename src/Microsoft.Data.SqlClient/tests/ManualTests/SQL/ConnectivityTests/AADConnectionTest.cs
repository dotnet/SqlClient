...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public class AADConnectionsTest
    {
        ...
        public static void InvalidAccessTokenTest()
        {
            ...
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, credKeys);
        ...
        public static void AccessTokenTestWithIntegratedSecurityTrue()
        {
            // Remove cred info and add invalid token
            string[] credKeys = { "User ID", "Password", "Authentication" };
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, credKeys) + "Integrated Security=True;";
        ...
        public static void InvalidAuthTypeTest()
        {
            // Remove cred info and add invalid token
            string[] credKeys = { "Authentication" };
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, credKeys) + "Authentication=Active Directory Pass;";
        ...
        {
            string connStr = DataTestUtility.s_aadPassConnString + "Integrated Security=True;";
        ...
        public static void AADPasswordWithWrongPassword()
        {
            ...
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, credKeys) + "Password=TestPassword;";
        ...
        {
            using (SqlConnection connection = new SqlConnection(DataTestUtility.s_aadPassConnString))
            {
                connection.Open();
            }
        }
        ...
        public static void testADPasswordAuthentication()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(DataTestUtility.s_aadPassConnString))
                {
                    conn.Open();
                    ...
                    string expected = RetrieveValueFromConnStr(DataTestUtility.s_aadPassConnString, "User ID");
        ...
        public static void ActiveDirectoryPasswordWithNoAuthType()
        {
            ...
            string connStrWithNoAuthType = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, AuthKey);
        ...
        public static void IntegratedAuthWithCred()
        {
            // connection fails with expected error message.
            string[] AuthKey = { "Authentication" };
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, AuthKey) + "Authentication=Active Directory Integrated;";
            ArgumentException e = Assert.Throws<ArgumentException>(() => ConnectAndDisconnect(connStr));
        ...
        public static void MFAAuthWithCred()
        {
            // connection fails with expected error message.
            string[] AuthKey = { "Authentication" };
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, AuthKey) + "Authentication=Active Directory Interactive;";
            ArgumentException e = Assert.Throws<ArgumentException>(() => ConnectAndDisconnect(connStr));
        ...
        public static void EmptyPasswordInConnStrAADPassword()
        {
            ...
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, pwdKey) + "Password=;";
            AggregateException e = Assert.Throws<AggregateException>(() => ConnectAndDisconnect(connStr));
        ...
        public static void EmptyCredInConnStrAADPassword()
        {
            ...
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, removeKeys) + "User ID=; Password=;";
            AggregateException e = Assert.Throws<AggregateException>(() => ConnectAndDisconnect(connStr));
        ...
        public static void AADPasswordWithInvalidUser()
        {
            ...
            string connStr = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, removeKeys) + "User ID=testdotnet@microsoft.com";
            AggregateException e = Assert.Throws<AggregateException>(() => ConnectAndDisconnect(connStr));
        ...
        public static void NoCredentialsActiveDirectoryPassword()
        {
            ...
            ConnectAndDisconnect(DataTestUtility.s_aadPassConnString);

            // connection fails with expected error message.
            string[] credKeys = { "User ID", "Password" };
            string connStrWithNoCred = RemoveKeysInConnStr(DataTestUtility.s_aadPassConnString, credKeys);
