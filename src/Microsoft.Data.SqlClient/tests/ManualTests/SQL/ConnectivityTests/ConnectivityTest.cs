...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests
{
    public static class ConnectivityParametersTest
    {
        ...
        private static readonly string s_connectionString = DataTestUtility.s_tcpConnString;
        ...
        {
            SqlConnectionStringBuilder builder = (new SqlConnectionStringBuilder(DataTestUtility.s_tcpConnString) { Pooling = true });
