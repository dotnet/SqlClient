...
namespace Microsoft.SqlServer.TDS.EndPoint.SSPI
{
    ...
    internal class SecurityWrapper
    {
        ...
        [DllImport(DllName, CharSet = CharSet.Unicode, EntryPoint = "AcquireCredentialsHandleW")]
        ...
        [DllImport(DllName, CharSet = CharSet.Unicode, SetLastError = false, EntryPoint = "InitializeSecurityContextW")]
        ...
        [DllImport(DllName, CharSet = CharSet.Unicode, EntryPoint = "QuerySecurityPackageInfoW")]
