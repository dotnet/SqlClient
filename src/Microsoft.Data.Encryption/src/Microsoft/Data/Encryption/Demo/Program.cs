...
namespace Microsoft.Data.Encryption.Demo
{
    static class Program
    {
        ...
        // Azure Key Vault URI
        public static readonly string KeyEncryptionKeyPath = keyEncryptionKeyPath;
        ...
        {
            // No setup required
            TheMostSimpleCase.Demo();

            // Some setup required
            SingleItemDefaultSettings.Demo();
            SingleItemCustomSettings.Demo();
            CustomObjectEncryption.Demo();
            IEnumerablePipelineEncryption.Demo();
            ParquetFileEncryption.Demo();
        }
    }
}
