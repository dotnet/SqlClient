...
namespace Microsoft.Data.Encryption.CryptographyTests.Serializers.SqlSerializers
{
    ...
    public class SqlNullableNumericSerializerShould : IDisposable
    {
        readonly SqlDatabaseFixture Database;

        public SqlNullableNumericSerializerShould(SqlDatabaseFixture fixture)
        {
            Database = fixture;
        }
        ...
        {
            Serializer<decimal?> serializer = new SqlNullableNumericSerializer();
        ...
        [Theory]
        [SqlNullableNumericSerializerTestData]
        public void SerializeTheSameAsSqlServer(decimal? plaintext, byte precision, byte scale)
        {
            Serializer<decimal?> serializer = new SqlNullableNumericSerializer(precision, scale);
        ...
        [Theory]
        [SqlNullableNumericSerializerInvalidTestData]
        ...
        [Theory]
        [SqlNullableNumericSerializerInvalidPrecisionData]
        public void ThrowWhenConstructorPrecisionOutOfRange(int precision)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new SqlNullableNumericSerializer(precision));
        }
        ...
        {
            SqlNullableNumericSerializer serializer = new SqlNullableNumericSerializer();
            Assert.Throws<ArgumentOutOfRangeException>(() => serializer.Precision = precision);
        }

        [Theory]
        [SqlNullableNumericSerializerInvalidScaleData]
        public void ThrowWhenConstructorScaleOutOfRange(int precision, int scale)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new SqlNullableNumericSerializer(precision, scale));
        }
        ...
        public class SqlNullableNumericSerializerInvalidPrecisionDataAttribute : DataAttribute
        {
        ...
        public class SqlNullableNumericSerializerInvalidScaleDataAttribute : DataAttribute
        {
            public override IEnumerable<object[]> GetData(MethodInfo testMethod)
            {
        ...
        public class SqlNullableNumericSerializerInvalidTestDataAttribute : DataAttribute
        {
            public override IEnumerable<object[]> GetData(MethodInfo testMethod)
            {
        ...
        public class SqlNullableNumericSerializerTestDataAttribute : DataAttribute
        {
            public override IEnumerable<object[]> GetData(MethodInfo testMethod)
            {
