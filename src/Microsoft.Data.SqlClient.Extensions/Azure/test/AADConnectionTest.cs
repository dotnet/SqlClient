...
public class AADConnectionTest
{
    private static class Config
    {
        ...
        static Config()
        {
            ConnectionString = GetEnvVar("AZURE_DB_TCP_CONN_STRING");
            ManagedIdentity = GetEnvVar("UserManagedIdentityClientId");
        }
    ...
    private static bool HasConnectionString() => Config.ConnectionString.NotEmpty();
    private static bool HasManagedIdentity() => Config.ManagedIdentity.NotEmpty();


    [ConditionalFact(nameof(HasManagedIdentity))]
    public static void KustoDatabaseTest()
    {
        ...
        using SqlConnection connection = new(
            ...
            $"User ID={Config.ManagedIdentity};");
        connection.Open();
