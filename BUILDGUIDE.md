...
**PowerShell** is included as a .NET local tool in this repository. Running `dotnet tool restore` (see below) will make it available. No separate installation is required.
