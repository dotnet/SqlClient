...
- Added dependency on `Microsoft.Data.SqlClient.Extensions.Logging` to align with the new extensions infrastructure introduced in `Microsoft.Data.SqlClient` 7.0.0-preview4.26064.3.
