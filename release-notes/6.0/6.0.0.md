...
#### Introducing SqlClientDiagnostics [#2226](https://github.com/dotnet/SqlClient/pull/2226)
...
#### Added Support for Connection Overrides in `OpenAsync()` API [#2433](https://github.com/dotnet/SqlClient/pull/2433)
...
- Dependency changes
  ...
  - Updated `Microsoft.Data.SqlClient.SNI` version to `6.0.1`. [#3096](https://github.com/dotnet/SqlClient/pull/3096)
