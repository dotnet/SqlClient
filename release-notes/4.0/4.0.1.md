...
- AppContext switch `SuppressInsecureTLSWarning` is added to make users to be able to supress TLS security warning while `Encrypt=false` on connection string. [#1467](https://github.com/dotnet/SqlClient/pull/1467) [Read more](#suppress-tls-security-warnings)
