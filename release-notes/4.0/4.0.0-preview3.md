...
## Microsoft.Data.SqlClient 4.0.0-preview3.x.x released 20 October 2021
...
- Add `GetFieldValueAsync<T>` and `GetFieldValue<T>` support for `XmlReader`, `TextReader`, `Stream` [#1019](https://github.com/dotnet/SqlClient/pull/1019). [Read more](#`GetFieldValueAsync<T>`-and-`GetFieldValue<T>`-support-for-`XmlReader`,-`TextReader`,-`Stream`-types)
